...
@interface ASTransitionController ()

@property (nonatomic) ASTransitionLayout* transitionLayout;
...
@implementation ASTransitionController
...
- (void)startInteractiveTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    self.transitionLayout = (ASTransitionLayout *)[fromCollectionViewController.collectionView startInteractiveTransitionToCollectionViewLayout:toCollectionViewController.collectionViewLayout completion:^(BOOL didFinish, BOOL didComplete) {
