...
@property (nonatomic, strong) ASCollectionViewLargeLayout *largeLayout;
@property (nonatomic, strong) ASCollectionViewSmallLayout *smallLayout;
...
//    [_collectionView addGestureRecognizer:gesture];
    ...
    // Custom layouts
    _smallLayout = [[ASCollectionViewSmallLayout alloc] init];
    _largeLayout = [[ASCollectionViewLargeLayout alloc] init];
